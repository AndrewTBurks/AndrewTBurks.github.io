...
The dog who is on high alert for criminals at night will watch you carefully as you move through the scene, barking if you get too close ([Sound #10](#sounds)). Additionally, many [People](#people) throughout the scene have audio triggers which will play a clip when you approach them.
...
[Models](#models) | [People](#people) | [Sounds](#sounds) | [Models In Action](#models-in-action) | [Top <i class="fas fa-angle-double-up"></i>](#glossary)
...
- <i class="fas fa-comment"></i> - Proximity Activated Speech

### Models

#### **C**reated Models

_(All models are visible all day_ <i class="far fa-clock"></i>_)_
...
_Note: List counts to 20 but total count is >30_
...
![BirdHouse](../images/528p1/tentsarea2.PNG "Campers at night with a Police Car in the background. With them they brought their Dog, three Tents, a Flashlight, and their Books.")
...
_**Note:** to improve your experience, make sure that your build settings are set high enough so that the dynamic daylight shadows are visible._

## Comparison

[CAVE2](#cave2) | [Vive](#vive) | [Reality](#reality) | [Top <i class="fas fa-angle-double-up"></i>](#glossary)
...
The floor missing in the CAVE2 is helpful in mitigating motion-sickness while in VR. By remaining grounded _(literally)_ to the real world, I also felt as if I was further removed from the virtual environment. This lapse of immersiveness did occasionally seem to pull me out of the virtual world. For some reason, since the picture was always as far away as the screens, I got the impression that every object was far away from me, but that the whole scene was smaller. It is possible that I would get better acclimated to using the CAVE2 after continued usage.
